ORI_FOLDER = 'pdmx/abc_small'  # Replace with the path to your folder containing standard ABC notation files
INTERLEAVED_FOLDER = 'pdmx/abc_interleaved'   # Output interleaved ABC notation files to this folder
AUGMENTED_FOLDER = 'pdmx/abc_aug'   # Output key-augmented and rest-omitted ABC notation files to this folder
