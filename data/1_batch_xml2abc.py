...
DES_FOLDER = "preprocessed/SymphonyNet_dataset/abc"   # The script will convert the musicxml files and output standard abc notation files to this folder
...
def convert_xml2abc(file_list):
    ...
    cmd = 'python xml2abc.py -u -d 8 -x -n 20000 '
