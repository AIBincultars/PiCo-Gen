ORI_FOLDER = "pdmx/mxl/mxl"  # Replace with the path to your folder containing XML (.xml, .mxl, .musicxml) files
DES_FOLDER = "pdmx/abc"   # The script will convert the musicxml files and output standard abc notation files to this folder
